  ...
  const confirmBooking = async (booking: Booking) => {
    ...
    try {
      ...
      const response = await fetch("/api/bookings/confirm", {
        ...
        body: JSON.stringify({ reference: booking.id, name: booking.name, email: booking.contact, service: booking.service, date: booking.date, time: booking.time, duration: booking.duration, price: booking.price }),
      });
      ...
      setNotice({ text: "La confirmation n’a pas pu être envoyée. Réessayez.", error: true });
    } finally {
      setSending("");
    }
  };
