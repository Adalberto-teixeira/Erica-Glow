...
export default function PwaInstallSection() {
  ...
  return <section className="pwa-install" id="installer" aria-labelledby="pwa-title">
    <div className="pwa-phone" aria-hidden="true"><Image src="/icons/icon-512.png" alt="" width={104} height={104}/><span>Erica Glow</span><small>Réservez en quelques clics</small></div>
